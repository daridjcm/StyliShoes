    ...
    <section>
      <form className="contact-form" noValidate>
        <div className="form-group">
          ...
          <input type="text" id="inputFullname" name="fullname" autoComplete="name" />
        </div>

        <div className="form-group">
          <label htmlFor="inputCountry">Select your country</label>
        ...
        <div className="form-group">
          ...
          <textarea id="inputMessage" name="message" rows="4"></textarea>
        </div>

        <div className="form-group form-check-group">
          <input type="checkbox" id="check" name="terms" />
          <label htmlFor="check">
            <p>Accept the <a href="./terms_conditions.html">terms and conditions</a>
            </p>
        </label>
        </div>
